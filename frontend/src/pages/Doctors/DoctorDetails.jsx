                ...
                <div className="md:col-span-2">
                    <div className="flex items-center gap-5">
                        ...
                        <div className="">
                            ...
                            {/* ---- Doctor's Name --------------- */}
                            <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Dr. Murphy Roger</h3>
                            ...
                            <p className='text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis voluptatum temporibus, ipsam culpa libero porro!!</p>
                        </div>
                    </div>

                    {/* ----------------- Created the 'About' & 'Feedback' section ------------ */}
