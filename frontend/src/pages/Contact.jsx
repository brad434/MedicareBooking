    ...
    return <section>
        <div className="px-4 mx-auto max-w-screen-md">
            ...
            <p className='mb-8 lg:mb-16 font-light text-center text__para'>
                Got a technical issue? Want to send feedback about a feature or error? Let us know.
            </p>
            ...
            <form action="#" className='space-y-8'>
                ...
                <div>
                    ...
                    <textarea rows="6" type="text" id='message' placeholder='Leave us a comment...' className='form__input mt-1' />
                </div>
